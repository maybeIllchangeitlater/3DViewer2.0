...
void CPUTransformation::ApplyRotation(QMatrix4x4 &,
                                      QVector<VerticeData> &, float, float,
                                      float) const {
//  Q_UNUSED(matrix);
//  std::swap(x, y);
//  y /= 60;
...
void CPUTransformation::MoveModel(QMatrix4x4 &, QVector<VerticeData> &,
