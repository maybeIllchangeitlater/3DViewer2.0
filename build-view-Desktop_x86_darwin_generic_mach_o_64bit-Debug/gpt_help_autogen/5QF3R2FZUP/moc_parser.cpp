...
QT_MOC_LITERAL(15, 9), // "ParseOver"
QT_MOC_LITERAL(25, 0) // ""

    },
    "s21::ObjParser\0ParseOver\0"
};
...
void s21::ObjParser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ObjParser *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->ParseOver((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ObjParser::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ObjParser::ParseOver)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<ObjParser, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<bool, std::false_type>
...
// SIGNAL 0
void s21::ObjParser::ParseOver(bool _t1)
{
